...
<div id="page-wrapper" >
            <div id="page-inner">
            <h2 class="my-3">Form Tambah PAKET</h2>
<form action="/home/savepaket" method="post" enctype="multipart/form-data">
<?=  csrf_field(); ?>
 ...
 <script>
  ...
  <div class="form-group row">
    <label for="tanggal" class="col-sm-3 col-form-label ">Tanggal Datang</label>
    <div class="col-sm-10">
